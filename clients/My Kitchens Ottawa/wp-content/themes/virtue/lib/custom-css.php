...
if(!empty($virtue['primary_color'])) {
  ...
  .woocommerce-message:before, .woocommerce-info:before, #nav-second ul.sf-menu a:hover, .posttags a:hover, .subhead a:hover, #kadbreadcrumbs a:hover, #wp-calendar a, .star-rating {color: '.$virtue['primary_color'].';}
.widget_price_filter .ui-slider .ui-slider-handle, .product_item:hover a.button:hover, .kad-btn-primary, html .woocommerce-page .widget_layered_nav ul.yith-wcan-label li a:hover, html .woocommerce-page .widget_layered_nav ul.yith-wcan-label li.chosen a,
...
.widget_layered_nav ul li.chosen a:hover, .shop_table .actions input[type=submit].checkout-button:hover, .wpcf7 input.wpcf7-back:hover, .order-actions .button:hover, input[type="submit"].button:hover, .product_item:hover a.button {background: '.$virtue['primary20_color'].';}';
} else {
  $color_primary30 = '';
}
